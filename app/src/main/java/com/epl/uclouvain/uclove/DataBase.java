...
// Table Client
    ...
    public static final String MEET_LOGIN = "login";
    public static final String MEET_DATE = "Date";
    public static final String MEET_HOUR = "Heure";

    public static final String MEET_TABLE_CREATE = "CREATE TABLE " + MEET_TABLE_NAME + " (" +
            MEET_LOGIN + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
            MEET_DATE + " TEXT, " +
            MEET_HOUR + " INTEGER " + ");";
